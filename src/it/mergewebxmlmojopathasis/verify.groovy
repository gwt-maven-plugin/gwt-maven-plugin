...
assert content.contains( '<servlet-name>org.codehaus.mojo.gwt.test.server.HelloRemoteServlet/HelloService</servlet-name>' );
assert content.contains( '<servlet-class>org.codehaus.mojo.gwt.test.server.HelloRemoteServlet</servlet-class>' );
assert content.contains( '<url-pattern>/HelloService</url-pattern>' );
