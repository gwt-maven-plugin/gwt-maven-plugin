...
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/com.google.gwt.sample.hello.Hello/gwt/standard').exists();
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/com.google.gwt.sample.hello.Hello/gwt/standard/images').exists();
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/com.google.gwt.sample.hello.Hello/gwt/standard/standard.css').exists();
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/com.google.gwt.sample.hello.Hello/gwt/standard/standard_rtl.css').exists();
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/hello/gwt/standard').exists();
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/hello/gwt/standard/images').exists();
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/hello/gwt/standard/standard.css').exists();
assert new File(basedir, 'target/gwt-compile-1.0-SNAPSHOT/hello/gwt/standard/standard_rtl.css').exists();
